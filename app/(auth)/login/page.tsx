...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-md bg-white/90 rounded-2xl shadow-sm border border-gray-100 p-8">
        <h1 className="text-2xl font-bold text-gray-900 mb-1">Welcome back</h1>
        <p className="text-gray-500 mb-6">Sign in to CalorieApp</p>
        ...
        <p className="mt-4 text-center text-sm text-gray-500">
          ...
          <Link href="/register" className="text-green-600 font-medium hover:underline">Sign up free</Link>
        </p>
      </div>
    </div>
  )
